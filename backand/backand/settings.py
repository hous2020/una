"""
Django settings for backand project.
...
SECRET_KEY = 'django-insecure-^g8ie96@#%ti1pu_us!d%+d#7f04vnvy@-9%=&$0f)njein3m%'
...
WSGI_APPLICATION = 'backand.wsgi.application'
...
# Pour une configuration plus restrictive en production, utilisez:
